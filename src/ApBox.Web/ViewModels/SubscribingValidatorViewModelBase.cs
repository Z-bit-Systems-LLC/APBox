...
/// <summary>
/// Base class for ViewModels that subscribe to notifications and use validation.
...
/// </summary>
public abstract class SubscribingValidatorViewModelBase : ObservableValidator, IDisposable
{
